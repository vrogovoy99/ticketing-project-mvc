...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(RoleService roleService, UserService userService) { //since Component RoleServiceImpl is created, spring will plug it in for RoleService interface - loose coupling!!!!
